...
pub fn printASTNodes(allocator:*Allocator, ast_nodes:*const std.ArrayList(*ASTNode)) !void {
...
fn printASTNode(allocator: *Allocator, node: ?*ASTNode, indent: usize, ast_type_text: []const u8) !void {
...
fn addSpacing(allocator:*Allocator, indent:usize, padding:*std.ArrayList(u8), i:usize) !void {
